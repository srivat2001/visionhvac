...
<li><a >  Vrf Gas Flow Type </a></li>
      ...
      useEffect(() => {  
        ...
        console.log(navhash.slice(1).includes("_"))
          if(document.getElementById(navhash.slice(1).replace("_"," "))){
            
            document.getElementById(navhash.slice(1).replace("_"," ")).scrollIntoView()
