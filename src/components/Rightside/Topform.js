        ...
        <div className="navitem_subsection">
          {mainurl ? (
            <Link
              onClick={closenavfc}
              to={{
                pathname: props.naviteminfo.link,
                hash: item,
              }}
            >
              {item}
            ...
            <a onClick={closenavfc} href={props.naviteminfo.link + "#" + item}>
              {item}
            </a>
          )}
        </div>
